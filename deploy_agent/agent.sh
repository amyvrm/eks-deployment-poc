...
ACTIVATIONURL='dsm://stag-agents.deepsecurity.trendmicro.com:443/'
MANAGERURL='https://staging.deepsecurity.trendmicro.com:443'
...
curl -H "Agent-Version-Control: on" $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=32563 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:AB932712-9A37-596A-46E2-D709FBE822EA" "token:D0E4E193-C14C-585A-57AA-2862AB4A2E1C" "policyid:$1" "groupid:$2"
#/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:AB932712-9A37-596A-46E2-D709FBE822EA" "token:D0E4E193-C14C-585A-57AA-2862AB4A2E1C" "policyid:$1" "groupid:760"
# /opt/ds_agent/dsa_control -a dsm://stag-agents.deepsecurity.trendmicro.com:443/ "tenantID:AB932712-9A37-596A-46E2-D709FBE822EA" "token:D0E4E193-C14C-585A-57AA-2862AB4A2E1C"