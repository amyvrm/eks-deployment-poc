...
class ComputersApi(object):
    ...
    def delete_computers(self, id_list, api_version, **kwargs):  # noqa: E501
        """Delete Computers  # noqa: E501

        Batch delete computers by a list of IDs. You cannot use this operation to delete a computer that is managed by a connector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_computers(id_list, api_version, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ComputersToBeDeletedIDList id_list: The ID list of the computers to be deleted. (required)
        :param str api_version: The version of the api being called. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_computers_with_http_info(id_list, api_version, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_computers_with_http_info(id_list, api_version, **kwargs)  # noqa: E501
            return data

    def delete_computers_with_http_info(self, id_list, api_version, **kwargs):  # noqa: E501
        """Delete Computers  # noqa: E501

        Batch delete computers by a list of IDs. You cannot use this operation to delete a computer that is managed by a connector.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_computers_with_http_info(id_list, api_version, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['id_list', 'api_version']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_computers" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id_list' not in params or
            ...
            raise ValueError("Missing the required parameter `id_list` when calling `delete_computers`")  # noqa: E501
        # verify the required parameter 'api_version' is set
        if ('api_version' not in params or
                params['api_version'] is None):
            raise ValueError("Missing the required parameter `api_version` when calling `delete_computers`")  # noqa: E501
